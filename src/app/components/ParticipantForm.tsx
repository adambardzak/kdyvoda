...
export default function ParticipantForm({ eventId, availableDates, onSubmit }: ParticipantFormProps) {
      ...
      {success && (
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-center">
            ...
            <p className="text-green-700 font-medium">Response submitted successfully!</p>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div>
          ...
          <input
            ...
            className="w-full rounded-md border-0 px-3 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm"
            required
          />
        </div>
        ...
        <div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            <div className="mb-4 flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-slate-600">Available Event Dates</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 bg-green-100 rounded-sm border border-green-200"></div>
                <span className="text-sm text-slate-600">Your Selected Dates</span>
              </div>
            </div>
            <Calendar
          ...
          {selectedDates.length > 0 && (
            <div className="mt-4">
              <h4 className="text-sm font-medium text-slate-700 mb-3">Your Selected Dates:</h4>
